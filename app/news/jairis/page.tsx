...
export default function JairisNewsPage() {
  return (
    <main className="max-w-6xl mx-auto px-6 mt-28 mb-24">
      ...
      <section className="mb-12">
        ...
        <p className="text-white/70 max-w-2xl">
          Noticias, vídeos y contenido multimedia sobre Hozono Global Jairis.
        </p>
      </section>
      ...
      <section className="rounded-2xl border border-white/10 bg-white/5 p-8">
        ...
        <p className="text-white/70 mb-6">
          Estamos preparando la página de cobertura específica de Hozono Global Jairis.
        </p>
