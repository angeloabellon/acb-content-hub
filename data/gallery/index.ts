...
const ucamMurciaUnicajaAccion: GalleryCollection = {
...
const ucamMurciaUnicajaGrada: GalleryCollection = {
...
const devontaeCacok: GalleryCollection = {
...
export const galleryCollections: GalleryCollection[] = [  ucamMurciaUnicajaAccion,
  ucamMurciaUnicajaGrada,
  devontaeCacok,
];